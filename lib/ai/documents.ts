    ...
    input: [
      {
        ...
        content: [
          ...
          'Write exactly four developed paragraphs in a consistent order: (0) job-specific motivation and fit, (1) relevant technical skills proven in projects and certifications, (2) practical professional experience, and (3) availability, contribution, and a short invitation to discuss the role.',
          ...
          'Paragraph 0: explain why this specific role and its actual responsibilities fit the candidate, what the candidate can contribute, and why that contribution matters for the advertised work. Address the named company naturally; avoid invented praise about its culture or products. Keep the opening focused on motivation, fit, and job responsibilities; reserve specific projects and technologies for paragraph 1, and do not repeat the same example across paragraphs.',
          "Paragraph 1: write 320-700 characters explaining at least two named technical skills from cited skills facts, chosen for relevance to the job. Name one verified project in which the candidate applied those skills and one relevant verified certification that supports the candidate's knowledge. Explain how this combination applies to an actual task in this listing; do not merely list technologies or credentials.",
          ...
          'Paragraph 3: after the required availability sentence, state concisely what the candidate would bring to the team and invite a conversation. Do not repeat the project, certification, or employer examples from earlier paragraphs.',
          'Keep all four paragraphs together, including the two required sentences, within 2400 characters. The complete rendered letter must fit on exactly one A4 page, so prefer specific evidence over repetition.',
