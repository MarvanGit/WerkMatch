    ...
    input: [
      {
        ...
        content: [
          ...
          'Paragraph 2: write 300-750 characters naming at least one employer from cited experience facts, describe concrete work performed there, and explain how it prepares the candidate for this job. Use Scale AI or Smstream where supported; never invent employer-specific technologies or achievements. A project can supplement but cannot replace professional experience.',
